...
revSchema.statics.getAriticleLastDate = function(title){
  var pipeline =     [
    {$match:{"title":title}},
    {$project:{"date":"$timestamp"}},   //修改输入文档的结构。可以用来重命名、增加或删除字段(域)，也可以用于创建计算结果以及嵌套文档。
    {$sort:{"date":-1}},
    {$limit:1}
]
  return this.aggregate(pipeline).exec()    
...
revSchema.statics.updateArticle = function(title,lastDate, callback){
  ...
  request(options,function(err, res, data){
    ...
    if (err){
     ...
     // console.log(Object.keys(pages)[0])   //Updated length:number
     /**
      * send request url:https://en.wikipedia.org/w/api.php?action=query&format=json&prop=revisions&titles=Hurricane%20Bob%20(1985)&rvstart=2018-01-04T13%3A54%3A39.000Z&rvdir=newer&rvprop=timestamp%7Cuserid%7Cuser%7Cids&rvlimit=max
{ pageid: 6935369,
  ns: 0,
  ...
  revisions: 
   [ { revid: 818597377,
       ...
       user: 'Quondum',
       userid: 12331483,
       timestamp: '2018-01-04T13:54:39Z' },
     { revid: 836472738,
       parentid: 818597377,
       user: 'InternetArchiveBot',
       userid: 27015025,
       timestamp: '2018-04-15T00:47:46Z' },
     { revid: 845128861,
       parentid: 836472738,
       user: 'CooperScience',
       userid: 30937206,
       timestamp: '2018-06-09T15:58:31Z' } ] }
Updated length:2
      */
    //  console.log(pages[Object.keys(pages)[0]])
      
      console.log(pages[Object.keys(pages)[0]].revisions)
     /*
      * [ { revid: 827509947,
    parentid: 827323317,
    user: 'AlbanGeller',
    userid: 28164502,
    timestamp: '2018-02-25T03:36:07Z' },
  { revid: 828083730,
    parentid: 827509947,
    user: 'Vikram maingi',
    userid: 6461930,
    timestamp: '2018-02-28T13:31:01Z' },
      * */
